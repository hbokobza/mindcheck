// api/payment.js — ES Modules (compatible "type":"module")
...
export default async function handler(req, res) {
  ...
  // ACTION 2 : confirmer + créer compte Supabase
  if (action === 'confirm') {
    ...
    try {
      ...
      await sb.auth.admin.createUser({ email, password: tempPwd, email_confirm: true })
        .catch(() => {});
